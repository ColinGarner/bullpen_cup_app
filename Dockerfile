...
# docker build -t bullpen_cup_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name bullpen_cup_app bullpen_cup_app
...
# Start server for Railway deployment with proper migration detection
